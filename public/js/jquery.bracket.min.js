...
!(function (t) {
  var e,
    ...
    i = (function () {
      return function (t, e, n) {
        if (
          ((this.first = t), (this.second = e), (this.userData = n), !t || !e)
        )
    ...
    a = (function () {
      ...
      return (
        Object.defineProperty(t.prototype, "name", {
          get: function () {
            return "function" == typeof this.nameOrGetter
              ? this.nameOrGetter()
              : this.nameOrGetter;
          },
          set: function (t) {
        ...
        (t.prototype.emptyBranch = function () {
          ...
          try {
            ...
            return this.source().sibling().emptyBranch() === e.TBD
              ? e.TBD
              : e.BYE;
          } catch (t) {
            if (t instanceof c) return e.END;
            throw new Error(
              'Unexpected exception type (message: "' + t.message + '")'
            );
          }
        }),
        t
    ...
    l = (function () {
      ...
      return (
        ...
        (t.prototype.winner = function () {
          return (
            t.teamsInResultOrder(this)[0] || t.emptyTeam(this.a.source, this.b)
          );
        }),
        (t.prototype.loser = function () {
          return (
            t.teamsInResultOrder(this)[1] || t.emptyTeam(this.b.source, this.a)
          );
        }),
        t
      );
    })();
  ((p = u || (u = {})).EMPTY_BYE = "empty-bye"),
    (p.EMPTY_TBD = "empty-tbd"),
    (p.ENTRY_NO_SCORE = "entry-no-score"),
    (p.ENTRY_DEFAULT_WIN = "entry-default-win"),
    (p.ENTRY_COMPLETE = "entry-complete");
  var p;
  function d(e, n, r) {
    ...
    return {
      highlight: function () {
        i.each(function () {
          t(this).addClass(o),
            t(this).hasClass("win") &&
              t(this).parent().find(".connector").addClass(o);
        });
      },
      deHighlight: function () {
        i.each(function () {
          t(this).removeClass(o),
            t(this).parent().find(".connector").removeClass(o);
        });
      },
    };
  }
  function f(e, n, r) {
    ...
    i.val(n),
      ...
      i.keydown(function (t) {
        ...
        (9 !== e && 13 !== e && 27 !== e) ||
          (t.preventDefault(), r(i.val(), 27 !== e));
      });
  }
  function m(t, e, n, r) {
    switch (r) {
      case u.EMPTY_BYE:
        return void t.append("NO PARTICIPANTE");
      case u.EMPTY_TBD:
        return void t.append("EN ESPERA");
  ...
  function b(t) {
    ...
    return (
      e.find(".team.lose").append('<div class="bubble fourth">4th</div>'), !0
    );
  }
  var v = function () {
      throw new c();
    ...
    C = function (t, e) {
      return function (n) {
        n.css("top", ""),
          ...
          e
            ? n.css("top", t.el.height() / 2 - n.height() / 2 + "px")
            : n.css("bottom", -n.height() / 2 + "px");
      };
    };
      ...
      return function (e, n) {
        ...
        return n
          ...
          .order.map(function (e) {
            return e.map(
              t ? i : { height: 0, shift: r },
              t ? i : { height: 2 * -r, shift: r }
            );
          })
          .orElse(i);
      };
  ...
  function B(i, o, s, a, c, l, p, d, f, m) {
    var g =
        s.name.isEmpty() || a.name.isEmpty()
          ? ""
          : 'data-resultid="result-' + d.getNext() + '"',
      b = t(
    ...
    var C = t(
        '<div class="team" style="width: ' +
          (p.teamWidth + p.scoreWidth) +
          'px;"></div>'
      ),
      E = t(
        '<div class="label" style="width: ' + p.teamWidth + 'px;"></div>'
      ).appendTo(C);
    p.decorator.render(
      E,
      s.name.toNull(),
    ...
    if (
      ...
      s.name.isEmpty()
        ? C.addClass("na")
        : o.winner().name === s.name
        ? C.addClass("win")
        : o.loser().name === s.name && C.addClass("lose"),
      C.append(b),
            ...
            !(function r() {
              e.unbind(),
                p.decorator.edit(e, s.name.toNull(), function (o, a) {
                  var h = s.seed.get();
                  (p.init.teams[~~(h / 2)][h % 2] = n.of(o || null)),
                    m(!0),
                    e.click(r);
                  var c = p.el.find(
            ...
            o.val(i),
              ...
              o.keydown(function (e) {
                ...
                if (9 === n || 13 === n || 27 === n) {
                  ...
                  var r = f.find(
                    "div.score[data-resultid=result-" + (M + 1) + "]"
                  );
                  r && r.click();
                }
              }),
              o.blur(function () {
                var t = o.val();
                (t && h(t)) || h(s.score)
                  ? (t && h(t)) || !h(s.score) || (t = s.score)
                  : (t = "0"),
                  e.html(t),
                  h(t) && ((s.score = r.of(parseInt(t, 10))), m(!0)),
                  e.click(n);
              });
          })();
        });
  ...
  var N = (function () {
      ...
      return (
            ...
            (function (e, n, r, i) {
              ...
              u.css("height", a),
                ...
                o >= 0
                  ...
                  : u.css("bottom", -o - 1 + "px"),
                h
                  ? u.css("border-bottom", "none")
                  : u.css("border-top", "none");
              var l = t('<div class="connector"></div>').appendTo(u);
              return (
                l.css("width", c + "px"),
                l.css(i, -c + "px"),
                h ? l.css("bottom", "0px") : l.css("top", "0px"),
                u
              );
        ...
        (e.prototype.results = function () {
          return (
            (this.match.a.name.isEmpty() || this.match.b.name.isEmpty()) &&
              (this.match.a.score = this.match.b.score = r.empty()),
            new i(this.match.a.score, this.match.b.score, this.matchUserData)
          );
        }),
        e
      );
    ...
    D = function (e) {
      var r = new O(),
        ...
        a = t('<div class="jQBracket ' + e.dir + '"></div>').appendTo(
          e.el.empty()
        );
      function h() {
        ...
        e.disableToolbar
          ? a.css(
              "width",
              t * (e.teamWidth + e.scoreWidth + e.roundMargin) + 10
            )
          : a.css(
              "width",
              t * (e.teamWidth + e.scoreWidth + e.roundMargin) + 40
            ),
          o &&
            i.teams.length <= 2 &&
            !e.skipConsolationRound &&
            a.css("height", s + 40);
      }
      var c, u, l;
      function p(n) {
        r.reset(),
          ...
          e.disableHighlight ||
            (function (e, n, r) {
              ...
              o &&
                s &&
                (o.name.isEmpty() ||
                  d(o.seed.get(), "highlightWinner", e).highlight(),
                s.name.isEmpty() ||
                  d(s.seed.get(), "highlightLoser", e).highlight()),
          ...
          n &&
            ((i.results[0] = c.results()),
            u && (i.results[1] = u.results()),
            l && !e.skipGrandFinalComeback && (i.results[2] = l.results()),
            h(),
            e.save && e.save(x(i), e.userData));
      }
      e.skipSecondaryFinal &&
        o &&
        t.error(
        ...
        e.disableToolbar ||
          (function (e, r, i) {
            ...
            if (
              ...
              (r.teams.length > 1 && 1 === r.results.length) ||
                (r.teams.length > 2 && 3 === r.results.length))
            ) {
            ...
            if (1 === r.results.length && r.teams.length > 1) {
              var a = t('<span class="doubleElimination">de</span>').appendTo(
                o
              );
              a.click(function () {
              ...
              var a = t('<span class="singleElimination">se</span>').appendTo(
                o
              );
              a.click(function () {
      ...
      o
        ...
        : (e.skipGrandFinalComeback ||
            (f = t('<div class="finals"></div>').appendTo(a)),
          (m = t('<div class="bracket"></div>').appendTo(a)),
          (v = t('<div class="loserBracket"></div>').appendTo(a))),
        m.css("height", s),
      ...
      return (
        ...
        o ||
          ((u = new M(v, n.of(i.results[1] || null), T, !1, e)),
          e.skipGrandFinalComeback ||
            (l = new M(f, n.of(i.results[2] || null), T, !1, e))),
        (function (t, e, r, i, o) {
          for (
            var s,
              a = Math.log(2 * e.length) / Math.log(2),
              h = e.length,
              c = 0;
            c < a;
            c += 1
          ...
          if (
            r &&
            (t.final().setConnectorCb(n.empty()),
            e.length > 1 && !i.skipConsolationRound)
          ) {
        ...
        o ||
          ((function (t, e, r, i, o) {
            for (
              var s = Math.log(2 * r) / Math.log(2) - 1, a = r / 2, h = 0;
              h < s;
              h += 1
            ) {
          ...
          e.skipGrandFinalComeback ||
            (function (t, e, r, i, o, s) {
              var a = t.addRound(n.empty()),
                h = a.addMatch(
                  ...
                  n.of(function (o) {
                    var a = !1;
                    if (
                      i.skipSecondaryFinal ||
                      o.winner().name.isEmpty() ||
                      o.winner().name !== r.winner().name
                    ) {
              ...
              if (
                (h.setAlignCb(function (t) {
                  var n = e.el.height() + r.el.height();
                  i.skipConsolationRound || (n /= 2),
                    h.el.css("height", n + "px");
                  var o =
                    (e.el.height() / 2 + e.el.height() + r.el.height() / 2) /
                      2 -
                    t.height();
                  t.css("top", o + "px");
                }),
                    ...
                    s = e
                      ...
                      .order.map(function (t) {
                        return t.map(
                          {
                            height: o + 2 * n,
                            shift: n * (i.centerConnectors ? 2 : 1),
                          },
                          {
                            height: o + n * (i.centerConnectors ? 2 : 0),
                            shift: n * (i.centerConnectors ? 2 : 3),
                          }
                        );
                      })
                      .orElse({
                        height: o + n * (i.centerConnectors ? 2 : 1),
                        shift: 2 * n,
                      }),
                    a = s.height,
                    h = s.shift;
  ...
  var F = function (t, e) {
    ...
    Y = function (t, e) {
      ...
      if ("boolean" !== n)
        throw new Error(
          "Value of " + e + " must be boolean, got boolean, got " + n
        );
    },
    P = function (t, e, n) {
      var r = e[n];
      if (r < t)
        throw new Error(
          "Value of " + n + " must be greater than " + t + ", got " + r
        );
    },
    W = {
      init: function (e) {
        ...
        if (
          (void 0 === o.userData && (o.userData = null),
          !(!o.decorator || (o.decorator.edit && o.decorator.render)))
        )
        ...
        a &&
          "boolean" !== s &&
          t.error("disableToolbar must be a boolean, got " + s),
          !o.save &&
            a &&
            t.error(
        ...
        c &&
          "boolean" !== h &&
          t.error("disableTeamEdit must be a boolean, got " + h),
          !o.save &&
            c &&
            t.error(
        ...
        g !== Math.floor(g) &&
          ...
          (o.dir = o.dir || "lr"),
          (o.init.teams =
            o.init.teams && 0 !== o.init.teams.length
              ? o.init.teams
              : [[null, null]]),
          ...
          "lr" !== o.dir &&
            "rl" !== o.dir &&
            t.error('Direction must be either: "lr" or "rl"');
        var b = D(o);
  ...
  t.fn.bracket = function (e) {
    return W[e]
      ...
      : "object" != typeof e && e
      ? void t.error("Method " + e + " does not exist on jQuery.bracket")
